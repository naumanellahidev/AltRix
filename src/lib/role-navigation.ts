...
export const NAV_CATALOG: NavItem[] = [
  ...
  // Fees follow the finance roles, as the server does (FINANCE_GOV), which
  // include the school admin who runs the fee office.
  ...
  { key: "transport", label: "Transport Management", icon: Bus, group: "operations", path: "transport",
    roles: ["super_admin","school_owner","principal","vice_principal","school_admin","teacher","student","parent","accountant","hr_manager"] },
  ...
  { key: "inventory", label: "Asset & Inventory", icon: PackageCheck, group: "operations", path: "inventory",
    roles: ["super_admin","school_owner","principal","vice_principal","school_admin","accountant","teacher"] },
  { key: "hostel", label: "Hostel & Boarding", icon: Home, group: "operations", path: "hostel",
    roles: ["super_admin","school_owner","principal","vice_principal","school_admin","teacher","student","parent","hr_manager","counselor"] },
  { key: "alumni", label: "Alumni Network", icon: GraduationCap, group: "operations", path: "alumni",
    roles: ["super_admin","school_owner","principal","vice_principal","school_admin","teacher","student","parent"] },
  { key: "complaints", label: "Complaints", icon: ShieldAlert, group: "operations", path: "complaints",
    roles: ["super_admin","school_owner","principal","vice_principal","school_admin","teacher","parent","student","counselor"] },
  ...
  { key: "doc-management", label: "DMS Vault", icon: FolderOpen, group: "operations", path: "doc-management",
    roles: ["super_admin","school_owner","principal","vice_principal","school_admin","academic_coordinator","teacher","hr_manager","accountant","student","parent"] },
  { key: "staff-appraisals", label: "Staff Appraisals", icon: ShieldCheck, group: "operations", path: "staff-appraisals",
    roles: ["super_admin","school_owner","principal","vice_principal","school_admin","academic_coordinator","teacher","student","hr_manager"] },
