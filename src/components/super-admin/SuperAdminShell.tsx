...
const NAV: { section: string; items: Item[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "11. System Health & SLA", to: "/super_admin/health", icon: Activity, badge: "99.99%" },
      { label: "12. Customer Support Desk", to: "/super_admin/support", icon: MessageSquare },
      { label: "13. Enterprise Keys & AI", to: "/super_admin/settings", icon: Settings },
    ],
  },
];
