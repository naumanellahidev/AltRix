      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white dark:bg-slate-900 p-2.5 sm:p-3 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-sm">
          <TabsList className="inline-flex w-full sm:w-auto p-1 rounded-xl bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
            ...
            >
              <MapPin className="h-3.5 w-3.5 mr-1.5" /> Routes ({routes.length})
            </TabsTrigger>
            <TabsTrigger
              value="fleet"
            ...
            >
              <Bus className="h-3.5 w-3.5 mr-1.5" /> Fleet ({fleet.length})
            </TabsTrigger>
            <TabsTrigger
              value="assignments"
              className="flex-1 sm:flex-initial data-[state=active]:bg-white data-[state=active]:text-blue-700 data-[state=active]:shadow-sm font-bold text-xs rounded-lg whitespace-nowrap py-1.5"
            >
              <Users className="h-3.5 w-3.5 mr-1.5" /> Roster ({assignments.length})
            </TabsTrigger>
          </TabsList>
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              className="h-10 text-xs rounded-xl bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 font-semibold shrink-0"
              title="Refresh Data"
            >
        ...
        ════════════════════════════════════════════════════════════════════ */}
        <TabsContent value="routes" className="space-y-4 m-0 w-full max-w-full min-w-0">
            ...
            <CardContent className="p-0 w-full max-w-full overflow-hidden min-w-0">
              {filteredRoutes.length === 0 ? (
                <div className="text-center py-16 px-4">
                  ...
                  <Button onClick={handleOpenAddRoute} size="sm" className="mt-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl text-xs font-bold h-9 px-3.5 shadow-sm">
        ...
        ════════════════════════════════════════════════════════════════════ */}
        <TabsContent value="fleet" className="space-y-4 m-0 w-full max-w-full min-w-0">
          <Card className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-sm rounded-2xl sm:rounded-3xl overflow-hidden w-full max-w-full min-w-0">
            <CardHeader className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3 border-b border-slate-100 dark:border-slate-800/80 p-3.5 sm:p-5 w-full min-w-0">
              <div className="min-w-0">
                <CardTitle className="text-sm sm:text-lg font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2 truncate">
            ...
            <CardContent className="p-0 w-full max-w-full overflow-hidden min-w-0">
              {filteredFleet.length === 0 ? (
                <div className="text-center py-16 px-4">
                  ...
                  <Button onClick={handleOpenAddBus} size="sm" className="mt-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl text-xs font-bold h-9 px-3.5 shadow-sm">
                            ...
                            <TableCell className="py-3.5 px-4 text-right whitespace-nowrap">
                              <div className="flex items-center justify-end gap-1.5">
                                <Button
                                  ...
                                  className="h-8 px-2.5 text-xs text-blue-700 bg-blue-50/60 hover:bg-blue-100 border-blue-200 rounded-lg font-semibold"
        ...
        ════════════════════════════════════════════════════════════════════ */}
        <TabsContent value="assignments" className="space-y-4 m-0 w-full max-w-full min-w-0">
          <Card className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-sm rounded-2xl sm:rounded-3xl overflow-hidden w-full max-w-full min-w-0">
            <CardHeader className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3 border-b border-slate-100 dark:border-slate-800/80 p-3.5 sm:p-5 w-full min-w-0">
              <div className="min-w-0">
                <CardTitle className="text-sm sm:text-lg font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2 truncate">
            ...
            <CardContent className="p-0 w-full max-w-full overflow-hidden min-w-0">
              {filteredAssignments.length === 0 ? (
                <div className="text-center py-16 px-4">
                  ...
                  <Button onClick={handleOpenAssignModal} size="sm" className="mt-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl text-xs font-bold h-9 px-3.5 shadow-sm">
        ...
        <DialogContent className="bg-surface border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-100 rounded-2xl sm:rounded-3xl w-[calc(100vw-1.5rem)] sm:max-w-2xl max-h-[90vh] overflow-y-auto overflow-x-hidden p-4 sm:p-6 shadow-2xl">
          ...
          <div className="space-y-4 pt-3">
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold rounded-xl sm:rounded-2xl h-10 sm:h-11 shadow-md text-xs sm:text-sm mt-3"
            >
            ...
            <div className="space-y-4 pt-3">
              ...
              <div className="p-3 bg-blue-50/60 dark:bg-slate-800/60 rounded-2xl border border-blue-100 dark:border-slate-700 space-y-2.5">
                ...
                <Button
                  ...
                  size="sm"
                  className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold rounded-xl text-xs h-8.5 shadow-xs"
                >
