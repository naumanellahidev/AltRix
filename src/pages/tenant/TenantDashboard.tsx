...
const DashboardHome = safeLazy(() => import("@/pages/tenant/modules/DashboardHome"), "DashboardHome");
const AdminConsole = safeLazy(() => import("@/pages/tenant/modules/AdminConsole"), "AdminConsole");
const PresenceDebugModule = safeLazy(() => import("@/pages/tenant/modules/PresenceDebugModule"));
const UsersModule = safeLazy(() => import("@/pages/tenant/modules/UsersModule"), "UsersModule");
const CrmModule = safeLazy(() => import("@/pages/tenant/modules/CrmModule"), "CrmModule");
const AcademicModule = safeLazy(() => import("@/pages/tenant/modules/AcademicModule"), "AcademicModule");
const AttendanceModule = safeLazy(() => import("@/pages/tenant/modules/AttendanceModule"), "AttendanceModule");
const PlatformSchoolsModule = safeLazy(() => import("@/pages/tenant/modules/PlatformSchoolsModule"), "PlatformSchoolsModule");
const ReportsModule = safeLazy(() => import("@/pages/tenant/modules/ReportsModule"), "ReportsModule");
const PrincipalHome = safeLazy(() => import("@/pages/tenant/role-homes/PrincipalHome"), "PrincipalHome");
const VicePrincipalHome = safeLazy(() => import("@/pages/tenant/role-homes/VicePrincipalHome"), "VicePrincipalHome");
const CounselorHome = safeLazy(() => import("@/pages/tenant/role-homes/CounselorHome"), "CounselorHome");
const AcademicCoordinatorHome = safeLazy(() => import("@/pages/tenant/role-homes/AcademicCoordinatorHome"), "AcademicCoordinatorHome");
const SupportModule = safeLazy(() => import("@/pages/tenant/modules/SupportModule"), "SupportModule");
const DirectoryModule = safeLazy(() => import("@/pages/tenant/modules/DirectoryModule"), "DirectoryModule");
const TimetableBuilderModule = safeLazy(() => import("@/pages/tenant/modules/TimetableBuilderModule"), "TimetableBuilderModule");
const MessagesModule = safeLazy(() => import("@/pages/tenant/modules/MessagesModule"), "MessagesModule");
const HrLeavesModule = safeLazy(() => import("@/pages/tenant/hr-modules/HrLeavesModule"), "HrLeavesModule");
const HrSalariesModule = safeLazy(() => import("@/pages/tenant/hr-modules/HrSalariesModule"), "HrSalariesModule");
const HrContractsModule = safeLazy(() => import("@/pages/tenant/hr-modules/HrContractsModule"), "HrContractsModule");
const HrReviewsModule = safeLazy(() => import("@/pages/tenant/hr-modules/HrReviewsModule"), "HrReviewsModule");
const HrDocumentsModule = safeLazy(() => import("@/pages/tenant/hr-modules/HrDocumentsModule"), "HrDocumentsModule");
const HrAttendanceModule = safeLazy(() => import("@/pages/tenant/hr-modules/HrAttendanceModule"), "HrAttendanceModule");
const MarketingLeadsModule = safeLazy(() => import("@/pages/tenant/marketing-modules/MarketingLeadsModule"), "MarketingLeadsModule");
const MarketingFollowUpsModule = safeLazy(() => import("@/pages/tenant/marketing-modules/MarketingFollowUpsModule"), "MarketingFollowUpsModule");
const MarketingCallsModule = safeLazy(() => import("@/pages/tenant/marketing-modules/MarketingCallsModule"), "MarketingCallsModule");
const MarketingSourcesModule = safeLazy(() => import("@/pages/tenant/marketing-modules/MarketingSourcesModule"), "MarketingSourcesModule");
const MarketingCampaignsModule = safeLazy(() => import("@/pages/tenant/marketing-modules/MarketingCampaignsModule"), "MarketingCampaignsModule");
const AccountantFeesModule = safeLazy(() => import("@/pages/tenant/accountant-modules/AccountantFeesModule"), "AccountantFeesModule");
const FeesUnifiedModule = safeLazy(() => import("@/pages/tenant/modules/FeesUnifiedModule"));
const OwnerFinanceModule = safeLazy(() => import("@/pages/tenant/owner-modules/OwnerFinanceModule"), "OwnerFinanceModule");

const AccountantInvoicesModule = safeLazy(() => import("@/pages/tenant/accountant-modules/AccountantInvoicesModule"), "AccountantInvoicesModule");
const AccountantPaymentsModule = safeLazy(() => import("@/pages/tenant/accountant-modules/AccountantPaymentsModule"), "AccountantPaymentsModule");
const AccountantExpensesModule = safeLazy(() => import("@/pages/tenant/accountant-modules/AccountantExpensesModule"), "AccountantExpensesModule");
const AccountantPayrollModule = safeLazy(() => import("@/pages/tenant/accountant-modules/AccountantPayrollModule"), "AccountantPayrollModule");
const AccountantLedgerModule = safeLazy(() => import("@/pages/tenant/accountant-modules/AccountantLedgerModule"), "AccountantLedgerModule");
const AccountantVendorsModule = safeLazy(() => import("@/pages/tenant/accountant-modules/AccountantVendorsModule"), "AccountantVendorsModule");
const AccountantTaxModule = safeLazy(() => import("@/pages/tenant/accountant-modules/AccountantTaxModule"), "AccountantTaxModule");
const NoticesModule = safeLazy(() => import("@/pages/tenant/modules/NoticesModule"));
const HolidaysModule = safeLazy(() => import("@/pages/tenant/modules/HolidaysModule"));
const DiaryModule = safeLazy(() => import("@/pages/tenant/modules/DiaryModule"));
const ExamsModule = safeLazy(() => import("@/pages/tenant/modules/ExamsModule"));
const ReportCardModule = safeLazy(() => import("@/pages/tenant/modules/ReportCardModule"));
const PrincipalComplaintsModule = safeLazy(() => import("@/pages/tenant/modules/PrincipalComplaintsModule"));
const PrincipalParentNotesModule = safeLazy(() => import("@/pages/tenant/modules/PrincipalParentNotesModule"));
...
const OwnerInsightsDashboard = safeLazy(() => import("@/pages/tenant/modules/OwnerInsightsDashboard"));
const DocManagementModule = safeLazy(() => import("@/pages/tenant/modules/DocManagementModule"));
const ExamSeatingPlanModule = safeLazy(() => import("@/pages/tenant/modules/ExamSeatingPlanModule"));
...
const AttendanceHeatmapPage = safeLazy(() => import("@/pages/tenant/principal/AttendanceHeatmapPage"));
const CollaborationHubPage = safeLazy(() => import("@/components/principal/CollaborationHub"), "CollaborationHub");
const BudgetSimulatorPage = safeLazy(() => import("@/pages/tenant/principal/BudgetSimulatorPage"));
          ...
          <RouteGuard>
            <Suspense fallback={<DashboardLoader />}>
              <Routes>
                ...
                <Route path="gate-visitor" element={<GateVisitorModule />} />
                ...
                <Route path="staff-appraisals" element={<StaffAppraisalModule />} />
