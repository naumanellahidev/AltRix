  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-primary/5 via-slate-50 to-primary/10 relative overflow-x-hidden font-sans">
      ...
      <header className="w-full pt-2 pb-2 sm:pb-3 px-6 flex flex-col items-center justify-center relative z-10">
        ...
        <p className="mt-2 text-xs sm:text-sm font-black text-slate-950 tracking-[0.25em] uppercase opacity-95">
          AI-POWERED INSTITUTE CORE SYSTEM
        </p>
      </header>
          ...
          <div className="bg-white/25 border border-white/40 shadow-elevated rounded-3xl p-5 sm:p-7 backdrop-blur-2xl relative overflow-hidden transition-all duration-300 hover:shadow-2xl hover:bg-white/30">
            ...
            {authMode === 'login' && (
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-sm shadow-md shadow-primary/20 hover:shadow-lg hover:shadow-primary/30 transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
            ...
            {authMode === 'forgot_password' && (
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-sm shadow-md shadow-primary/20 hover:shadow-lg hover:shadow-primary/30 transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-60"
                  disabled={busy}
                >
                  {busy ? (
      ...
      <footer className="w-full bg-white/50 border-t border-slate-200/50 py-4 px-6 sm:px-8 relative z-10 backdrop-blur-md mt-auto">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center opacity-90 hover:opacity-100 transition-opacity duration-200">
          ...
          <div className="flex gap-6 sm:gap-8 justify-center flex-wrap">
            <Link to="/privacy" className="text-xs sm:text-sm font-semibold text-slate-600 hover:text-primary transition-colors">
              Privacy Policy
            </Link>
            <Link to="/terms" className="text-xs sm:text-sm font-semibold text-slate-600 hover:text-primary transition-colors">
              Terms of Service
            </Link>
            <Link to="/compliance" className="text-xs sm:text-sm font-semibold text-slate-600 hover:text-primary transition-colors">
              Compliance
            </Link>
            <Link to="/security" className="text-xs sm:text-sm font-semibold text-slate-600 hover:text-primary transition-colors">
              Security
            </Link>
          </div>
