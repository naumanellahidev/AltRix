  ...
  <table class="main-card" width="100%" cellpadding="0" cellspacing="0">
    <tr>
      <td class="header">
        ...
        <div style="margin-top: 14px; padding: 8px 16px; background: rgba(255,255,255,0.06); border-radius: 8px; border: 1px solid rgba(255,255,255,0.12); color: #cbd5e1; font-size: 13px; font-weight: 600; display: inline-block;">
          {{{{tenant.name}}}} &bull; Altrix Core — The AI-Powered Institute Operating System
        </div>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="footer">
        ...
        <p style="margin: 0 0 6px 0; color: #64748b;">&copy; {{{{year}}}} Altrix Core &bull; The AI-Powered Institute Operating System &bull; All rights reserved.</p>
        ...
        <p style="margin: 0; font-size: 11px; color: #94a3b8; max-width: 480px; margin: 0 auto; line-height: 1.4;">
          This official communication was securely generated by Altrix Core on behalf of {{{{tenant.name}}}}.
        </p>
      </td>
    </tr>
  </table>
...
ALL_TEMPLATES = [
    # ── AUTHENTICATION ────────────────────────────────────────────────────────
    {
        ...
        "subject": "Invitation to Join {{tenant.name}} on Altrix Core",
        ...
        "html_content": _wrap_body(
            ...
            <p>You have been formally invited to join the official digital workspace of <strong>{{tenant.name}}</strong> powered by <strong>Altrix Core — The AI-Powered Institute Operating System</strong>.</p>
            <div class="info-box">
    ...
    },
    {
        ...
        "category": "Authentication",
        "subject": "Welcome to Altrix Core",
        "sender_identity_key": "info",
        "cta_text": "Explore Altrix Core Portal",
        "cta_url_variable": "portal_link",
        "available_variables": ["name", "portal_link"],
        "html_content": _wrap_body(
            badge_text="Platform Welcome",
            badge_color="#eff6ff",
            title="Welcome to Altrix Core",
            content="""
            <p>Hello <strong>{{name}}</strong>,</p>
            <p>We are delighted to welcome you to <strong>Altrix Core — The AI-Powered Institute Operating System</strong>, the unified institutional intelligence and operating platform.</p>
        ...
        "text_content": "Hello {{name}}, welcome to Altrix Core — The AI-Powered Institute Operating System. Visit: {{portal_link}}"
    },
    {
        "key": "security_alert",
    ...
    },
    {
        ...
        "category": "System",
        "subject": "Altrix Core — Version {{version_number}} Released",
        "sender_identity_key": "info",
        ...
        "html_content": _wrap_body(
            ...
            content="""
            <p>Hello <strong>{{name}}</strong>,</p>
            <p>We are excited to announce the release of <strong>Altrix Core v{{version_number}}</strong>!</p>
            <div class="info-box">
        ...
        "text_content": "Altrix Core v{{version_number}} is live! Highlights: {{release_highlights}}. Read more: {{changelog_link}}"
    },
]
