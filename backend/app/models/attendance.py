...
class AttendanceEntry(Base):
    ...
    status: Mapped[str] = mapped_column(String, nullable=False, default="present")  # present, absent, late, excused
...
class StaffAttendance(Base):
    ...
    status: Mapped[str] = mapped_column(String, nullable=False, default="present")  # present, absent, late, half_day, leave
